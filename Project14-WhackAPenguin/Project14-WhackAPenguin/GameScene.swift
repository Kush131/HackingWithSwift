...
//
//  Created by Kush, Ryan on 1/17/19.
...
class GameScene: SKScene {
    ...
    func createEnemy() {
        ...
        // Decrese the popup time to make the game harder
        popupTime *= 0.991

        // Shuffle the slots so we pick a random slot to pop up.
        slots.shuffle()
    ...
    override func didMove(to view: SKView) {
        ...
        // Create slots at every position
